	...
	return (
      ...
      <div id='alert-head' className="alertBox-head">
          <div className="alert_box">
            <div className="icon"><i className="fa-regular fa-address-card"></i></div>
              <header>Confirm</header>
              <p>Your UserAdd is Successfully Done.</p>
              <div className="btns">
              <label onClick={CloseAlert} htmlFor="check">Ok</label>
              </div>
          </div>
      </div>
							...
							<div
								...
								<h2 className="accordion-header">
									<button
										...
										data-bs-target={`#collapse${sUser.id}`}
										aria-expanded="false"
